 ...
 * The Snowballs Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Snowballs Wallet"));
#ifndef Q_WS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Snowballs address"));
    ...
    aboutAction->setToolTip(tr("Show information about Snowballs"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Snowballs"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/toolbar"), tr("Show/Hide &Snowballs"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Snowballs window"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Snowballs client"));
    ...
    notificator = new Notificator(tr("Snowballs-qt"), trayIcon);
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Snowballs network", "", count));
}
